...
public class PictureService : System.Web.Services.WebService
{
    ...
    public byte[] GetPicture(string strFileName)
    {
        ...
        try
        {
            ...
            FileStream picFileStream = new
                FileStream(@"D:\Git\비트\BitClass\WCF&WebService\IIS" + strFileName, FileMode.Open,FileAccess.Read, FileShare.Read);
    ...
    public string[] GetPictureList()
    {
        ...
        string[] strPicList = Directory.GetFiles(@"D:\Git\비트\BitClass\WCF&WebService\IIS");
    ...
    public bool UploadPicture(string strFileName, byte[] bytePic)
    {
        try
        {
            ...
            FileStream writeFileStream = new FileStream(@"D:\Git\비트\BitClass\WCF&WebService\IIS" + strFileName, FileMode.Create,FileAccess.Write);
