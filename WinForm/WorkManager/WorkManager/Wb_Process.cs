...
namespace WorkManager
{
    class WbProcessData
    {
        ...
        public WbProcessData(string pname, int id, DateTime st, long psize, int tcount, string oname, long wset, ProcessPriorityClass pclass, TimeSpan stime, string state)
        {
            ProcessName = pname;
            Id = id;
            StartTime = st;
