...
namespace WinFormStart1014
{
    class Program /*: Form*/
    {
        ...
        {
            DialogResult r;
            r= MessageBox.Show("Form_Load", "알림", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        {
            DialogResult r;
            r = MessageBox.Show("죽일꺼냐?", "알림", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
