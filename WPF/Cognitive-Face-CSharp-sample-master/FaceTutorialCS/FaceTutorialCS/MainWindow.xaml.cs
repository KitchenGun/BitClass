...
namespace FaceTutorial
{
    public partial class MainWindow : Window
    {
        ...
        private static string subscriptionKey = "dc9d3feb951f41559e27b677c4adf15e";
        // Add your Face endpoint to your environment variables.
        private static string faceEndpoint = "https://kang9714.cognitiveservices.azure.com/";
        ...
        private void FacePhoto_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            for (int i = 0; i < faceList.Count; ++i)
            {
                    ...
                    mouseXY.Y >= top && mouseXY.Y <= top + height)
                {
                    ...
                    speechSynthesizer.SpeakAsync("Face Description "+faceDescriptionStatusBar.Text);
                    mouseOverFace = true;
                    break;
                }
                else
