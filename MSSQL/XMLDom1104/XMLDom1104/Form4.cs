...
namespace _1103XML
{
    public partial class Form4 : Form
    {
        ...
        {
            AccountXML.GetXMLFileLoad("accounts.xml");
            textBox1.Text = AccountXML.GetXmlData();

            List<Wb.XMLPaser.Account> acclist = AccountXML.DocumentPrint();
        ...
        {
            AccountIOXML.GetXMLFileLoad("acclistio.xml");
            textBox2.Text = AccountIOXML.GetXmlData();

            List<Wb.XMLPaser.AccountIO> acclist = AccountIOXML.DocumentPrint();
