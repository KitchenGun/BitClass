...
namespace Test
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                stum.StuDelete(int.Parse(textBox1.Text));
                PrintStudent();
                TextClear();
            }
            catch
        ...
        {
            stum.StuUpdate(int.Parse(textBox1.Text), (SubjectType)(comboBox1.SelectedIndex + 1), (comboBox2.SelectedIndex + 1));
            PrintStudent();
            TextClear();
        }
        #endregion
