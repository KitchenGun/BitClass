...
{
	GetDlgItemText(hDlg, IDC_EDIT1, pmemberdata->id, sizeof(pmemberdata->id));
	GetDlgItemText(hDlg, IDC_EDIT2, pmemberdata->pw, sizeof(pmemberdata->pw));
	GetDlgItemText(hDlg, IDC_EDIT4, pmemberdata->name, sizeof(pmemberdata->name));
